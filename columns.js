...
// Демо-набор для 10 сид-строк реестра — сотрудник развивается сразу на несколько должностей,
// у каждой своя программа обучения, процент прохождения и дата завершения HARD.
// hardDate:'' означает, что программа ещё не завершена на 100% — даты завершения пока нет.
