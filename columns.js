...
const DEMO_DEV_TRACKS = [
  { position:'Старший кассир',     program:'Кадровый резерв на должность Старший кассир',     percent:89, hardDate:'2026-01-01' },
  { position:'Начальник отдела',   program:'Кадровый резерв на должность Начальник отдела',   percent:98, hardDate:'2026-02-01' },
...
const DEV_TRACKS_VARIANTS = [
  // 1. Полный пример — три должности сразу
  [
    { position:'Старший кассир',     program:'Кадровый резерв на должность Старший кассир',     percent:89, hardDate:'2026-01-01' },
    { position:'Начальник отдела',   program:'Кадровый резерв на должность Начальник отдела',   percent:98, hardDate:'2026-02-01' },
    { position:'Заведующий складом', program:'Кадровый резерв на должность Заведующий складом', percent:11, hardDate:'' },
  ...
  // 4. Две должности, одна из них — по управленческому треку
  [
    { position:'Директор магазина', program:'Кадровый резерв на должность Директор магазина', percent:67, hardDate:'' },
    { position:'Начальник отдела',  program:'Кадровый резерв на должность Начальник отдела',  percent:82, hardDate:'2026-03-01' },
  ],
  ...
  // 6. Две должности из смежных треков
  [
    { position:'Старший кассир',     program:'Кадровый резерв на должность Старший кассир',     percent:45, hardDate:'' },
    { position:'Заведующий складом', program:'Кадровый резерв на должность Заведующий складом', percent:60, hardDate:'2026-04-01' },
  ],
  // 7. Совсем без потенциальных должностей — ещё не определился
  [],
  // 8. Две должности, обе достаточно далеко
  [
    { position:'Старший кассир',   program:'Кадровый резерв на должность Старший кассир',   percent:92, hardDate:'2026-01-15' },
    { position:'Начальник отдела', program:'Кадровый резерв на должность Начальник отдела', percent:30, hardDate:'' },
  ],
  // 9. Одна должность — директорский трек
  [
    { position:'Директор отделения (ДО)', program:'Кадровый резерв на должность Директор отделения', percent:58, hardDate:'' },
  ],
  // 10. Две должности, обе близки к завершению
  [
    { position:'Начальник отдела',   program:'Кадровый резерв на должность Начальник отдела',   percent:99, hardDate:'2026-01-20' },
